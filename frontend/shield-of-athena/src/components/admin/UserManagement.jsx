...
function UserManagement() {
  const [users] = useState([
    ...
    { id: 3, name: 'Jean Viewer', email: 'jean@shield.org', role: 'Read-Only', lastLogin: '2024-11-14 16:45', status: 'active' },
    { id: 4, name: 'Sophie Manager', email: 'sophie@shield.org', role: 'Full Admin', lastLogin: '2024-11-13 11:20', status: 'inactive' },
  ]);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-600">Gérer les accès administrateurs</p>
            </div>
                ...
                <tr key={user.id} className="hover:bg-gray-50">
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                      user.role === 'Full Admin' ? 'bg-red-100 text-red-800' :
